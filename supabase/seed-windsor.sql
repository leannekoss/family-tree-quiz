...
insert into places (id, name, lat, lon, commune, geo_precision, geo_source, outside) values
  ...
  (2, 'Madrid', 40.416944444, -3.703333333, null, 'exact', 'Wikidata P625', true),
  (3, 'Munich', 48.1375, 11.575, null, 'exact', 'Wikidata P625', true),
  (4, 'St Mary''s Hospital', 51.517222222, -0.173055555, null, 'exact', 'Wikidata P625', false),
  (5, 'Francfort-sur-le-Main', 50.110555555, 8.682222222, null, 'exact', 'Wikidata P625', true),
  (6, 'Rome', 41.893055555, 12.482777777, null, 'exact', 'Wikidata P625', true),
  (7, 'Potsdam', 52.4009309, 13.0591397, null, 'exact', 'Wikidata P625', true),
  (8, 'Darmstadt', 49.866666666, 8.65, null, 'exact', 'Wikidata P625', true),
  ...
  (11, 'Berlin', 52.516666666, 13.383333333, null, 'exact', 'Wikidata P625', true),
  (12, 'Athènes', 37.984166666, 23.728055555, null, 'exact', 'Wikidata P625', true)
on conflict (id) do nothing;
